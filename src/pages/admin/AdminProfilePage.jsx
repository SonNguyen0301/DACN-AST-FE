      ...
      <Header style={{ background: "#fff", padding: "0 40px", display: "flex", alignItems: "center", justifyContent: "space-between", boxShadow: "0 2px 10px rgba(0,0,0,0.08)", position: 'sticky', top: 0, zIndex: 1000 }}>
        ...
        <Menu
          ...
          items={[
            ...
            { key: "2", label: "Quản lý Bác sĩ" },
            { key: "3", label: "Quản lý Nhân viên" },
          ]}
          onClick ={({ key }) => {
            switch (key) {
              case "1": navigate('/admin/dashboard'); break;
              case "2": navigate('/admin/doctors'); break;
              case "3": navigate('/admin/staffs'); break;
              default: break;
            }
          }}
        ...
        <Dropdown menu={{ items: menuUserItems }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, cursor: 'pointer' }}>
             <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', lineHeight: '1.2' }}>
                ...
                <span style={{ fontSize: 12, color: '#888' }}>Super Admin</span>
            </div>
            <Avatar size={40} icon={<UserOutlined />} style={{ backgroundColor: '#f5222d' }} />
          </div>
        </Dropdown>
      </Header>
